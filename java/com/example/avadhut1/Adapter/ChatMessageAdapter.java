package com.example.avadhut1.Adapter;
...
public class ChatMessageAdapter extends ArrayAdapter<ChatMessage> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (viewType == MY_MESSAGE) {
            ...
            convertView = LayoutInflater.from(getContext())
                    .inflate(R.layout.bot_replay_layout, parent, false);


            TextView textView = convertView.findViewById(R.id.text);
            textView.setText(getItem(position).getContent());
        }
        convertView.findViewById(R.id.chatMessageView).setOnClickListener(v -> Toast.makeText(getContext(), "Clicked...", Toast.LENGTH_SHORT).show());
        return convertView;
    }
